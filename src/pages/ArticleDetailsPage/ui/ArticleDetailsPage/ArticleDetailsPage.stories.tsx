...
const article: Article = {
  ...
  user: {
    ...
    username: 'user',
    avatar:
      'https://cdn0.iconfinder.com/data/icons/occupation-002/64/programmer-programming-occupation-avatar-1024.png',
  },
};

const meta = {
  title: 'pages/article/ArticleDetails/ArticleDetailsPage',
