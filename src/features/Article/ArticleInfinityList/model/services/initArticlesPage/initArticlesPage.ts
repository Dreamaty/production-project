...
>(
  ...
  async (searchParams, thunkApi) => {
    ...
    if (!inited) {
      ...
      orderFromUrl &&
        dispatch(articleSortActions.setOrder(orderFromUrl));
      sortFromUrl &&
        dispatch(articleSortActions.setSort(sortFromUrl));
      searchFromUrl &&
        dispatch(articleSortActions.setSearch(searchFromUrl));
      typeFromUrl &&
        dispatch(articleTypeTabsActions.setType(typeFromUrl));
