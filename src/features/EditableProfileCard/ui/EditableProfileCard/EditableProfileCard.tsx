...
import { ProfileCard } from 'entity/ProfileState'
...
import { profileStateActions, profileStateReducer } from '../../model/slice/profileStateSlice'
...
export const EditableProfileCard = memo(({ className, id }: {className?: string, id: string}) => {
